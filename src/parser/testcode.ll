...
(FUNCTION  main  []
  ...
  (BB 7
    ...
    (OPER 77 LT [(r 46)]  [(r 5)(r 45)])
    (OPER 78 BEQ []  [(r 46)(i 0)(bb 9)])
  )
  (BB 10
    (OPER 79 Mov [(r 47)]  [(i 48)])
    (OPER 80 Add_I [(r 48)]  [(r 47)(r 5)])
    (OPER 81 Pass []  [(r 48)] [(PARAM_NUM 0)])
    (OPER 82 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 83 Mov [(r 49)]  [(m RetReg)])
    (OPER 84 Mov [(r 50)]  [(i 1)])
    (OPER 85 Add_I [(r 51)]  [(r 5)(r 50)])
    (OPER 86 Mov [(r 5)]  [(r 51)])
    (OPER 87 Mov [(r 52)]  [(i 10)])
    (OPER 88 LT [(r 53)]  [(r 5)(r 52)])
    (OPER 89 BNE []  [(r 53)(i 0)(bb 10)])
  )
  (BB 9
    (OPER 90 Mov [(r 54)]  [(i 10)])
    (OPER 91 Pass []  [(r 54)] [(PARAM_NUM 0)])
    (OPER 92 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 93 Mov [(r 55)]  [(m RetReg)])
    (OPER 94 Mov [(r 56)]  [(i 67)])
    (OPER 95 Pass []  [(r 56)] [(PARAM_NUM 0)])
    (OPER 96 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 97 Mov [(r 57)]  [(m RetReg)])
    (OPER 98 Mov [(r 58)]  [(i 83)])
    (OPER 99 Pass []  [(r 58)] [(PARAM_NUM 0)])
    (OPER 100 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 101 Mov [(r 59)]  [(m RetReg)])
    (OPER 102 Mov [(r 60)]  [(i 3510)])
    (OPER 103 Pass []  [(r 60)] [(PARAM_NUM 0)])
    (OPER 104 JSR []  [(s printInt)] [(numParams 1)])
    (OPER 105 Mov [(r 61)]  [(m RetReg)])
    (OPER 106 Mov [(r 62)]  [(i 10)])
    (OPER 107 Pass []  [(r 62)] [(PARAM_NUM 0)])
    (OPER 108 JSR []  [(s putchar)] [(numParams 1)])
    ...
    (OPER 121 EQ [(r 70)]  [(r 1)(r 69)])
    (OPER 122 BEQ []  [(r 70)(i 0)(bb 12)])
  )
  (BB 11
    (OPER 123 Mov [(r 71)]  [(i 0)])
    (OPER 124 EQ [(r 72)]  [(r 2)(r 71)])
    (OPER 125 BEQ []  [(r 72)(i 0)(bb 15)])
  )
  (BB 14
  ...
  (BB 18
    ...
    (OPER 134 EQ [(r 78)]  [(r 4)(r 77)])
    (OPER 135 BEQ []  [(r 78)(i 0)(bb 21)])
  )
  (BB 20
  ...
  (BB 15
    ...
    (OPER 129 EQ [(r 75)]  [(r 3)(r 74)])
    (OPER 130 BEQ []  [(r 75)(i 0)(bb 18)])
  )
  (BB 17
